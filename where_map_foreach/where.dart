void main(List<String> args) {
  ...
  numbers2.where((element) => element > 3).forEach((element) {
  ...
  names2.where((element) => element.startsWith('A')).forEach((element) {
    filteredNames.add(element);
  });
  print(filteredNames);
  ...
  names3.where((element) => element.startsWith('A') && element.endsWith('d')).forEach((element) {
    filteredNames2.add(element);
  });
  ...
  numbers3.where((element) => element > 4).forEach((element) {
    if (firstNumberGreaterThan4 == null) {
      firstNumberGreaterThan4 = element;
  ...
  people.where((element) => element['name'] == 'John').forEach((element) {
    johns.add(element);
  });
  print(johns);
